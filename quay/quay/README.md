...
Run your own **local Quay Container Registry** with Docker Compose — including PostgreSQL and Redis for full Quay functionality.  
...
Don’t forget to update your **Bearer Token** and environment variables under the *Authentication* section before sending requests.
